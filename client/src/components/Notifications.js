...
function Notifications({ showNotifications, setShowNotifications }) {
  ...
  // Memoize readNotifications with useCallback
  ...
  }, [notifications, readNotifications]); // Include readNotifications in the dependencies
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-5 mt-5">
        ...
        {notifications.map((notification) => (
          <div
            key={notification._id} // Ensure to include a unique key for each notification
