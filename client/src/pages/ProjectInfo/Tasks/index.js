...
//     },
//     {
//       title: "Deadline", // New column for deadline
//       dataIndex: "deadline", // This should match the key you have in your task data
//       render: (text, record) => getDateFormat(record.deadline), // Format the deadline
//     },
//     {
//       title: "Status",
//       dataIndex: "status",
...
function Tasks({ project }) {
  ...
  // Wrap getTasks with useCallback
  ...
  }, [filters, dispatch, project._id]); // Adding filters as dependency
  ...
  useEffect(() => {
    getTasks();
  }, [getTasks]); // Dependency added here
  ...
  const columns = [
    ...
    },
    {
      title: "Deadline", 
      dataIndex: "deadline", 
      render: (text, record) => getDateFormat(record.deadline),
    },
    {
      title: "Status",
      dataIndex: "status",
